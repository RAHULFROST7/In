...
window.addEventListener("load",()=>{
  ...
  function startTimestamp() {
    if ('speechSynthesis' in window){
      speech('Welcome to the virtual interview i am lucifer, your AI interviewer, all the best for your interview and now shall we start the interview. The first question is ' + questions[i]);
    }
    else{
